    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 border border-gray-200">
          <h2 className="text-2xl font-bold text-center mb-6 text-gray-900">Masuk atau Buat Akun</h2>
          ...
          <form className="space-y-4" onSubmit={(e) => handleSubmit(e, formData)}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border text-gray-900 bg-white border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full px-3 text-gray-900 py-2 border bg-white border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400"
              />
            </div>
            ...
            <div className="flex items-start">
              <input
                ...
                name="terms"
                required
                className="mt-1 mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 bg-white"
              />
        ...
        <div className="mt-8 bg-white border border-gray-200 rounded-lg p-6 shadow-md">
          ...
          <Link 
            href="/register" 
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md font-semibold transition-colors shadow-lg hover:shadow-xl"
          >
            Daftar sekarang
          </Link>
        </div>
        ...
        <div className="mt-6 text-center">
          ...
          <div className="flex justify-center space-x-4">
            <Link href="https://www.facebook.com" className="text-gray-600 hover:text-gray-900 transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </Link>
            <Link href="https://www.instagram.com" className="text-gray-600 hover:text-gray-900 transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="https://www.youtube.com" className="text-gray-600 hover:text-gray-900 transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
